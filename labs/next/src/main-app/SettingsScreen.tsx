                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        if (!result?.installed) setInstallError(result?.reason || "The update could not restart Kosmos. Your work remains open.");
                      } catch { setInstallError("The update could not restart Kosmos. Your work remains open."); }
                    }}
                  >
                    Get update
                  </button>
