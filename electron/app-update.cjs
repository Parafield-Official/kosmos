/**
 * Installed Kosmos copies check GitHub Releases for a later version.
...
function copyFor(state) {
  ...
  if (state.phase === "error") {
    return "Could not update Kosmos automatically. The booth still works. If this copy cannot update itself, download the latest installer from GitHub once.";
  }
