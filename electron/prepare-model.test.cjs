...
describe("local development speech-model staging", () => {
  it("stages the official model under vendor/models for developer verification", () => {
  ...
  it("only treats a verified model status as development-ready", () => {
