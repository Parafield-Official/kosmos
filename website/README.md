...
React, Vite, TypeScript, and Tailwind CSS source for the Kosmos GitHub Pages
site.
...
cinematic palette. The Apple New York files are not included because their
license does not permit website embedding or distribution.
